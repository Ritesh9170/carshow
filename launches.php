...
<body>
    ...
    <div class="container">
        <div class="upcardetail">
            ...
            <p>Stay updated with new car launches, comprehensive car reviews, latest car news, expert advice and much more on our website. The list of new car launches in 2025 includes BMW 3 Series LWB (Rs. 72.42 Lakh) and Audi RS Q8 (Rs. 2.87 Crore). Get latest information about 69 new cars launches in the last six months. Kia Syros (Rs. 10.22 Lakh) is the most popular new car launched in India.</p>
        </div>
    </div>
    <div class="container pt-4">
        <h3 class="py-2">Latest Cars 2025</h3>
        <div class="row">
        <?php
