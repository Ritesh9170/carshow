...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-md-6 col-lg-6 col-12">
         <?php 
            $id =  base64_decode(base64_decode(base64_decode($_GET['LToffer'])));
            $sql = "select * from launchcar where id ='$id'";
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-12 offer">
            <div class="latbox">
                <div class="pt-4">
                <h3><i class="fa-regular fa-circle-xmark"style="color: #000; width: 50px"></i> <?php echo $name ?></h3>
              ...
              <label class="form-check-label" for="flexCheckDefault">
                I am interested in <span class="fw-semibold"><?php echo $name?></span>
              </label>
            </div>
            <div class="form-floating mt-4">
